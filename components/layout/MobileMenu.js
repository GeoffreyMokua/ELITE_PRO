                ...
                <nav className="menu-box">
                    ...
                    <div className="menu-outer">
                        ...
                        <li><Link href="/recruitment-services">Recruitment Services</Link></li>
                                ...
                                <li className={isActive.key == 4 ? "dropdown current" : "dropdown"}><Link href="/faq">FAQ's</Link>
                                ...
                                <li className={isActive.key == 5 ? "dropdown current" : "dropdown"}><Link href="/contact-1">CONTACT US</Link>
