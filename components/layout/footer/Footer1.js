            ...
            <footer className="main-footer sp-two">
                                ...
                                <div className="row">
                                    <div className="col-md-7">
                                        <div className="footer-widget logo-widget">
                                            <div className="widget-content">
                                                ...
                                                <h3>We are dedicated to equipping individuals with the skills and knowledge necessary for various careers. </h3>
                                    ...
                                    <div className="col-md-5">
                                        <div className="footer-widget links-widget">
                                            ...
                                            <div className="widget-content">
                                                <ul>
                                                    <li><Link href="#">Caregiver Training</Link></li>
                                                    <li><Link href="#">Homecare Training</Link></li>
                                                    <li><Link href="#">Languages</Link></li>
                                                    <li><Link href="#">Pre-departure Training</Link></li>
                                                    <li><Link href="#">Leadership Training</Link></li>
                                                    <li><Link href="#">Customer Service Training</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="footer-widget links-widget">
                                            ...
                                            <div className="widget-content">
                                                <ul>
                                                    ...
                                                    <li><Link href="#">Video Guides</Link></li>
                ...
                <div className="auto-container">
                    <div className="footer-bottom">
                        ...
                        <div className="copyright">© {new Date().getFullYear()} <Link href="#">ELITEPRO INTERNATIONAL</Link> Consultancy, All Rights Reserved.</div>
                    </div>
                </div>
            </footer>
